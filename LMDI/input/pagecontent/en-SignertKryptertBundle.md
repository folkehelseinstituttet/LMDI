...
The 256-bit AES key from step 3 is encrypted with Legemiddelregisteret's public RSA key. This is available in the certificates that can be downloaded [here](en-nedlastinger.html).
