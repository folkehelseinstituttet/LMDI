...
|---------|------|-------------|
| 1.1.3 | 2026-08-13 | MedicationRequest: `requester` is no longer mandatory (1..1 → 0..1). The field is still Must Support and shall be provided when the requester is known. The change does not invalidate any previously submitted data, but consumers can no longer assume the field is always present. |
