...
|---------|------|-------------|
| 1.0.7 | 2025-09-30 | Fjernet country-feltet fra adresse i Pasient og Organisasjon<br/>address.type satt til physical i Pasient (kun fysiske adresser)<br/>Endret kommune-extension fra propertyInformation til municipalitycode i Pasient |
