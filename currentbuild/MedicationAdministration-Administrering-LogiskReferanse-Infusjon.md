# Administrering-LogiskReferanse-Infusjon - Legemiddeldata fra institusjon til Legemiddelregisteret v1.0.8
...
* **Administrering-LogiskReferanse-Infusjon**

## Example MedicationAdministration: Administrering-LogiskReferanse-Infusjon
...
```json
{
  ...
  "id" : "Administrering-LogiskReferanse-Infusjon",
  "meta" : {
