# Del av behandlingsregime - Legemiddeldata fra institusjon til Legemiddelregisteret v1.1.2
...
| | |
| :--- | :--- |
| *Official URL*:http://hl7.no/fhir/ig/lmdi/StructureDefinition/lmdi-del-av-behandlingsregime **  | *Version*:1.1.2 **  |
| Active as of 2026-06-12 | *Computable Name*:DelAvBehandlingsregime |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/hl7.fhir.no.lmdi|current/StructureDefinition/StructureDefinition-lmdi-del-av-behandlingsregime.json)
...
```json
{
  ...
  "_description" : {
    "extension" : [{
      ...
      {
        "url" : "content",
        "valueString" : "The name of the regimen, treatment protocol, or course the medication is given as part of. Particularly relevant in chemotherapy."
      }],
      "url" : "http://hl7.org/fhir/StructureDefinition/translation"
    }]
  },
