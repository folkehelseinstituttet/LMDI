# Organisasjon-Sykehjem - Legemiddeldata fra institusjon til Legemiddelregisteret v1.1.0
...
**identifier**: `urn:oid:2.16.578.1.12.4.1.4.101`/985626154

**name**: BYNESET OG NYPANTUNET HELSE- OG VELFERDSSENTER SYKEHJEM

**address**: 

**partOf**: [Organization TRONDHEIM KOMMUNE](Organization-Organisasjon-Kommune.md)
