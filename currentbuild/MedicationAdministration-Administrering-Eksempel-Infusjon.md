# Administrering-Eksempel-Infusjon - Legemiddeldata fra institusjon til Legemiddelregisteret v1.0.8
...
* **Administrering-Eksempel-Infusjon**

## Example MedicationAdministration: Administrering-Eksempel-Infusjon
...
```json
{
  ...
  "id" : "Administrering-Eksempel-Infusjon",
  "meta" : {
