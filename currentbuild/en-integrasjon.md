# Integration - Legemiddeldata fra institusjon til Legemiddelregisteret v1.1.0
...
Data transferred to the API must be encrypted and signed (see [SignedEncryptedBundle](en-SignertKryptertBundle.md)).
...
* For encrypting data, the public key in the Medication Registry’s enterprise certificate is used. This can be downloaded [here](en-nedlastinger.md)
...
1. Implement the OAuth 2.0 Client Credentials flow with JWT bearer token. It is recommended to use the Altinn library:`https://github.com/Altinn/altinn-apiclient-maskinporten`
