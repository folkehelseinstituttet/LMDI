...
1. Implement OAuth 2.0 Client Credentials flow with JWT bearer token. It is recommended to use the Altinn library:`https://github.com/Altinn/altinn-apiclient-maskinporten`
