...
**code**: Lokalt legemiddel med ketamin, haloperidol, klonidin og midazolam

> **ingredient****item**:Ketamin Abcur inj, oppl 10 mg/ml**strength**: 2 mg(Details: UCUM codemg = 'mg')/1 mL(Details: UCUM codemL = 'mL')

> **ingredient****item**:Haldol inj, oppl 5 mg/ml**strength**: 0.5 mg(Details: UCUM codemg = 'mg')/1 mL(Details: UCUM codemL = 'mL')

> **ingredient****item**:Catapresan øresund inj, oppl 150 mikrog/ml**strength**: 1.5 ug(Details: UCUM codeug = 'ug')/1 mL(Details: UCUM codemL = 'mL')

> **ingredient****item**:Midazolam Accordpharma inj/inf, oppl 1 mg/ml**strength**: 0.2 mg(Details: UCUM codemg = 'mg')/1 mL(Details: UCUM codemL = 'mL')
