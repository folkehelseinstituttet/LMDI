# Artifacts Summary - Legemiddeldata fra institusjon til Legemiddelregisteret v1.1.3
...
| [Virkestoff](StructureDefinition-lmdi-substance.md) | En tilpasset profil av Substance for å representere virkestoff, basert på no-basis-Substance. |
...
| [Mengde ingrediens](StructureDefinition-lmdi-ingredient-strength.md) | Mengde ingrediens i det rekvirerte/administrerte legemidlet, angitt som Quantity eller som kode. Angir enten mengden virkestoff av ingrediensen i det rekvirerte/administrerte legemidlet (f.eks. 100 mg) eller hvilket volum av ingrediensen som er brukt for å produsere det rekvirerte/administrerte legemidlet (f.eks. 10 mL). Når volum benyttes skal ingredient.item angi «utgangslegemidlet» som ble brukt for å produsere det rekvirerte/administrerte legemidlet på en slik måte at «utgangslegemidlets» styrke kan utledes. Dette er nødvendig for å kunne beregne mengde virkestoff og styrke av ingrediensen i det rekvirerte/administrerte legemidlet. |
...
| [Legemiddel-Smerteblanding](Medication-Legemiddel-Smerteblanding.md) | Eksempel på lokalt tilberedt smerteblanding på 100 mL med morfin 5 mg/ml og midazolam 1 mg/ml. Viser de tre måtene å angi en ingrediens på, og bruk av mengde (mL) i tillegg til styrke. |
...
| [Virkestoff-Natriumklorid](Substance-Virkestoff-Natriumklorid.md) | Eksempel på virkestoff - Natriumklorid |
