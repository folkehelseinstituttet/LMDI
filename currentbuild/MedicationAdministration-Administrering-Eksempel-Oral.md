# Administrering-Eksempel-Oral - Legemiddeldata fra institusjon til Legemiddelregisteret v1.0.8
...
* **Administrering-Eksempel-Oral**

## Example MedicationAdministration: Administrering-Eksempel-Oral
...
```json
{
  ...
  "id" : "Administrering-Eksempel-Oral",
  "meta" : {
