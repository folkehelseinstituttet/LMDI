# Oksykodonadministrering i sykehjem med inline ressurskopier - Legemiddeldata fra institusjon til Legemiddelregisteret v1.1.0
...
Bundle Bundle-Scenario-Sykehjem-Oksykodon of type transaction
...
Entry 2 - fullUrl = urn:uuid:22222222-2222-4222-8222-222222222222
...
Entry 3 - fullUrl = urn:uuid:33333333-3333-4333-8333-333333333333
...
**identifier**:`urn:oid:2.16.578.1.12.4.1.4.101`/942110464**name**: TRONDHEIM KOMMUNE
...
Entry 4 - fullUrl = urn:uuid:44444444-4444-4444-8444-444444444444
...
**identifier**:`urn:oid:2.16.578.1.12.4.1.4.101`/985626154**name**: BYNESET OG NYPANTUNET HELSE- OG VELFERDSSENTER SYKEHJEM
...
**partOf**:[Organization TRONDHEIM KOMMUNE](Bundle-Bundle-Scenario-Sykehjem-Oksykodon.md#urn-uuid-33333333-3333-4333-8333-333333333333)
...
Entry 5 - fullUrl = urn:uuid:55555555-5555-4555-8555-555555555555
...
**status**: In Progress**class**:short stay**serviceProvider**:[Organization BYNESET OG NYPANTUNET HELSE- OG VELFERDSSENTER SYKEHJEM](Bundle-Bundle-Scenario-Sykehjem-Oksykodon.md#urn-uuid-44444444-4444-4444-8444-444444444444)
...
Entry 6 - fullUrl = urn:uuid:66666666-6666-4666-8666-666666666666
...
**Legemiddel Classification**:Oksykodon**identifier**:[festLegemiddelVirkestoff](NamingSystem-no-basis-fest-legemiddelvirkestoff.md)/C31AF94A-5D5A-4C91-9B99-BB221E26E4C9**code**:Oksykodon
...
Entry 7 - fullUrl = urn:uuid:77777777-7777-4777-8777-777777777777
...
**Prosentvis doseendring**: 80 %(Details: UCUM code% = '%')**Del av behandlingsregime**: FOLFOX6**Klinisk studie**: true**status**: Active**intent**: Order**subject**:[Anonymous Patient Male, DoB: 1958-05-12 ( urn:oid:2.16.578.1.12.4.1.4.1#12705825562)](Bundle-Bundle-Scenario-Sykehjem-Oksykodon.md#urn-uuid-11111111-1111-4111-8111-111111111111)**encounter**:[Encounter: status = in-progress; class = short stay (ActCode#SS)](Bundle-Bundle-Scenario-Sykehjem-Oksykodon.md#urn-uuid-55555555-5555-4555-8555-555555555555)**authoredOn**: 2025-03-10**requester**:[Practitioner: identifier = urn:oid:2.16.578.1.12.4.1.4.4#9144900](Bundle-Bundle-Scenario-Sykehjem-Oksykodon.md#urn-uuid-22222222-2222-4222-8222-222222222222)
...
Entry 8 - fullUrl = urn:uuid:88888888-8888-4888-8888-888888888888
...
**status**: completed**subject**:[Anonymous Patient Male, DoB: 1958-05-12 ( urn:oid:2.16.578.1.12.4.1.4.1#12705825562)](Bundle-Bundle-Scenario-Sykehjem-Oksykodon.md#urn-uuid-11111111-1111-4111-8111-111111111111)**request**:[MedicationRequest: extension = 80 %,FOLFOX6,true; status = active; intent = order; medication[x] = ->Medication Oksykodon; authoredOn = 2025-03-10](Bundle-Bundle-Scenario-Sykehjem-Oksykodon.md#urn-uuid-77777777-7777-4777-8777-777777777777)
