# Legemiddel - Legemiddeldata fra institusjon til Legemiddelregisteret v1.1.3
...
| | |
| :--- | :--- |
| *Official URL*:http://hl7.no/fhir/ig/lmdi/StructureDefinition/lmdi-medication **  | *Version*:1.1.3 **  |
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "short" : "Styrken av ingrediensen i det rekvirerte/administrerte legemidlet.",
      "_short" : {
        "extension" : [{
          "extension" : [{
            "url" : "lang",
          ...
          {
            "url" : "content",
            "valueString" : "The strength of the ingredient in the requested/administered medication."
          }],
          "url" : "http://hl7.org/fhir/StructureDefinition/translation"
        }]
      },
      "definition" : "Styrken av ingrediensen i det rekvirerte/administrerte legemidlet.",
      "_definition" : {
        "extension" : [{
          "extension" : [{
            "url" : "lang",
    ...
    {
      "id" : "Medication.ingredient.strength.extension:mengde",
      "path" : "Medication.ingredient.strength.extension",
      "sliceName" : "mengde",
      "short" : "Mengde ingrediens i det rekvirerte/administrerte legemidlet.",
      "_short" : {
        "extension" : [{
          "extension" : [{
            "url" : "lang",
          ...
          {
            "url" : "content",
            "valueString" : "Amount of the ingredient in the requested/administered medication."
          }],
          "url" : "http://hl7.org/fhir/StructureDefinition/translation"
        }]
      },
      "definition" : "Mengde ingrediens i det rekvirerte/administrerte legemidlet, angitt som volum eller mengde virkestoff (Quantity), eller som kode (qs, trace). Brukes i stedet for teller og nevner i strength.",
      "_definition" : {
        "extension" : [{
          "extension" : [{
            "url" : "lang",
          ...
          {
            "url" : "content",
            "valueString" : "Amount of the ingredient in the requested/administered medication, expressed as a volume or amount of active ingredient (Quantity), or as a code (qs, trace). Used instead of numerator and denominator in strength."
          }],
          "url" : "http://hl7.org/fhir/StructureDefinition/translation"
        }]
      },
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://hl7.no/fhir/ig/lmdi/StructureDefinition/lmdi-ingredient-strength"]
      }]
    },
    {
      "id" : "Medication.batch",
